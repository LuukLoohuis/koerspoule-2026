...
export default function Rondleiding({
  ...
  const stappen: Stap[] = [
    ...
    sub("subpoules", "klassement", t("subpoule.manager.tabRanking"), t("rondleiding.subpoule.ranking")),
          {
      navKey: "subpoules",
      titel: t("rondleiding.vergelijken.titel"),
      tekst: t("rondleiding.vergelijken.subpoule"),
      ga: { sectie: "subpoules", sub: "klassement" },
      doel: "subpoules-vergelijk",
    },
    ...
    sub("uitslagen", "klassement", t("results.view.klassementTab"), t("rondleiding.uitslagen.klassement")),
    {
      navKey: "uitslagen",
      titel: t("rondleiding.vergelijken.titel"),
      tekst: t("rondleiding.vergelijken.uitslagen"),
      ga: { sectie: "uitslagen", sub: "klassement" },
      doel: "uitslagen-vergelijk",
    },
