...
export type Thema = {
  ...
  logo: string;
  /** Ronde koersbadge als favicon; bewust los van het volledige logo. */
  favicon: string;
  /**
...
export const THEMAS: Record<ThemaKey, Thema> = {
  ...
  winter: {
    ...
    favicon: "/favicon-meermarathon.png",
    logoVerhouding: 480 / 320,
